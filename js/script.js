...
const texts = [
    { text: "Cipher Shadows", size: 150 },
    { text: "A Infiltração Global", size: 80 }
];
...
button.style.top = `${canvas.height / 2 + 200}px`; 
...
button.addEventListener('click', () => {
    particles.forEach(particle => {
        particle.dx = (Math.random() - 0.5) * 50; 
        particle.dy = (Math.random() - 0.5) * 50; 
    });
    ...
    function flyParticles() {
        ...
        requestAnimationFrame(flyParticles);
    }
    flyParticles(); 
